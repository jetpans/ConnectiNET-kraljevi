	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC5 - Brisanje racuna}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC7 - Kontrola pregleda popisa dogadaja}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC8 - Pregled podataka o dogadaju}}
					\begin{packed_item}

						\item \textbf{Glavni sudionik: }Korisnik, organizator
