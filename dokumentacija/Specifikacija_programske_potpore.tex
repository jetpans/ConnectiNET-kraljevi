	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\begin{packed_enum}
					...
					\item stvoriti, uređivati ili izbrisati vlastiti javni profil
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC26 - Stvaranje javnog profila}}
					\begin{packed_item}
	
						\item \textbf{Glavni sudionik:} Organizator
						\item  \textbf{Cilj:} Stvaranje javnog profila
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Organizator nema kreiran javni profil
						\item  \textbf{Opis osnovnog tijeka:}
						...
						\item[] \begin{packed_enum}
							...
							\item Organizator odabire opciju "Kreiraj javni profil"
							\item Organizator unosi podatke o sebi
							\item Organizator odabire opciju "Kreiraj profil"
						\end{packed_enum}
						...
						\item[] \begin{packed_item}
							...
							\item[5.a] Organizator nije unio nužne podatke
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC27 - Uređivanje javnog profila}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC28 - Brisanje javnog profila}}
					\begin{packed_item}
	
						\item \textbf{Glavni sudionik:} Organizator
						\item  \textbf{Cilj:} Brisanje javnog profila
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Organizator ima kreiran javni profil
						\item  \textbf{Opis osnovnog tijeka:}
						...
						\item[] \begin{packed_enum}
							...
							\item Organizator odabire opciju "Osobni podatci"
							\item Organizator odabire opciju "Javni profil"
							\item Organizator odabire opciju "Izbriši javni profil"
						...
						\item[] \begin{packed_item}
							...
							\item[4.a] Organizator ipak ne želi izbrisati javni profil
							\item[] \begin{packed_enum}
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[htbp]
						\centering
						\includegraphics[width=1\textwidth]{dijagrami/obrazac_fukcionalnost_posjetitelja.jpg}
					...
					\begin{figure}[htbp]
						\centering
						\includegraphics[width=1\textwidth]{dijagrami/obrazac_fukcionalnost_organizatora.jpg}
					...
					\begin{figure}[htbp]
						\centering
						\includegraphics[width=1\textwidth]{dijagrami/obrazac_fukcionalnost_administratora.png}
