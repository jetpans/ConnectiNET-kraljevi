	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[htbp]
						\centering
						\includegraphics[width=1\textwidth]{slike/obrazac_fukcionalnost_organizatora.jpg}
					...
					\begin{figure}[htbp]
						\centering
						\includegraphics[width=1\textwidth]{slike/obrazac_fukcionalnost_administratora.png}
