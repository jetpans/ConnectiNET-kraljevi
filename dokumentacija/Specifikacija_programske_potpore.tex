	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\begin{packed_enum}
					...
					\item upravljati načinom prikaza popisa događaja
					\begin{packed_enum}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Sustav vraća korisniku obrazac za registraciju
							\item Korisnik unosi potrebne korisničke podatke
							\item Sustav provjerava točnost unesenih podataka i da li je korisničko ime već zauzeto
					...
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Organizator je prijavljen (vidi UC2)
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik pregledava osobne podatke (vidi UC3)
						...
						\item[] \begin{packed_item}
							...
							\item[5.a] Račun nije pronađen u bazi podataka
							\begin{packed_enum}
								\item Sustav prikazuje poruku "Greška - Račun ne postoji!"
							\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik ima mogućost filtriranja događaja po kategorijama, lokacijama, vremenu izvođenja i cijeni događaja
							\item Korisnik ima mogućnost sortiranja događaja po popularnosti (interesu), vremenu izvođenja te cijeni događaja
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire događaj (vidi UC6)
							\item Prikazuje mu se detalji o događaju poput naziva, vrste, lokacije, vremena početka, trajanja, foto galerije te popis recenzija
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Posjetitelj otvara stranicu s popisom događaja (vidi UC6)
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Posjetitelj otvara stranicu s popisom događaja (vidi UC6)
							\item Odabire događaj
							\item Posjetitelj odabire opciju "Prikaži sve recenzije"
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnikove recenzije za sve događaje se prikazuju
							\item Administrator odabire opciju "Ukloni recenziju" na nekoj od recenzija
					...
					\noindent \underbar{\textbf{UC25 - Uređivanje javnog profila}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC26 - Skrivanje javnog profila}}
					\begin{packed_item}
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[htbp]
						\centering
						\includegraphics[width=1\textwidth]{dijagrami/obrazac_funkcionalost_posjetitelja_new.png}
					...
					\begin{figure}[htbp]
						\centering
						\includegraphics[width=1\textwidth]{dijagrami/obrazac_funkcionalnost_organizatora_new.png}
					...
					\begin{figure}[htbp]
						\centering
						\includegraphics[width=1\textwidth]{dijagrami/obrazac_funkcionalnost_administratora_new.png}
		...
		\newpage
				...
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=1\textwidth]{dijagrami/UC5-seq.png}
     ...
     \eject
		...
		\section{Ostali zahtjevi}
			...
			\begin{itemize}
				...
				\item Sustav treba biti jednostavan za korištenje, korisnici trebaju znati koristiti korisničko sučelje bez opširnih uputa
